            ...
            <footer className="footer">
                <div className="footer-content">
                    <div className="footer-section">
                        <h4>Coffee Toffee</h4>
                        <p>Bringing the world's finest specialty coffees to your home. Crafted with passion, roasted with precision.</p>
                    </div>
                    <div className="footer-section">
                        <h4>Quick Links</h4>
                    ...
                    <div className="footer-section">
                        <h4>Contact Us</h4>
                        <div className="contact-details"><i className="fas fa-phone"></i><span>+91 98765 43210</span></div>
                        <div className="contact-details"><i className="fas fa-envelope"></i><span>hello@coffeetoffee.com</span></div>
                        <div className="contact-details"><i className="fas fa-map-marker-alt"></i><span>Chennai, Tamil Nadu, India</span></div>
                    </div>
                    <div className="footer-section">
                        <h4>Follow Us</h4>
                ...
                <div className="footer-bottom">
                    <p>
                        ...
                        <span style={{ color: "var(--accent-gold)" }}>❤</span> for Coffee Lovers |{" "}
...
/* SUPPORT */
.ct-root .support-section { padding: 6rem 2rem; background: linear-gradient(135deg, var(--primary-brown) 0%, var(--secondary-brown) 100%); color: var(--white); }
...
.ct-root .form-group input { width: 100%; padding: 1rem; border: 2px solid #eee; border-radius: 10px; font-size: 1rem; transition: all 0.3s ease; font-family: 'Poppins', sans-serif; }
...
.ct-root .login-btn { width: 100%; background: linear-gradient(135deg, var(--primary-brown) 0%, var(--secondary-brown) 100%); color: var(--white); padding: 1.2rem; border: none; border-radius: 10px; font-weight: 700; font-size: 1rem; cursor: pointer; transition: all 0.3s ease; }
...
.ct-root .phone-frame { width: 300px; height: 600px; background: #000; border-radius: 40px; padding: 12px; box-shadow: 0 30px 80px rgba(0,0,0,0.5); position: relative; transform: rotateY(10deg) rotateX(5deg); transition: transform 0.6s ease; }
...
/* FOOTER */
.ct-root .footer { background: var(--primary-brown); color: var(--white); padding: 4rem 2rem 1.5rem; }
